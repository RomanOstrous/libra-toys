      ...
      <div className="home">
        ...
        <div className="home__box container grid">
          ...
          <div className="home__info grid__item--desktop-2-7 grid__item--tablet-1-6">
            ...
            Ми креативно ставимося до екології, тому що не хочемо, щоб наша планета була як космічний смітник.
            Та переробляємо матеріали, багато з яких приходять у наші іграшки з інших старих речей.
            </p>
          </div>
          ...
          <div className="home__container grid__item--desktop-2-7 grid__item--tablet-1-6">
            ...
            <div className="home__info ">
              ...
              <p className="home__info-text">
                Замовляєш іграшку, а отримуєш враження, ніби розпаковуєш подарунок від космічного іншопланетянина.
